...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    coordinator.start_keepalive()  # no-op unless KEEPALIVE (off: no working IMU -> no shake pushes)
    coordinator.start_location_tracking()  # real-time nearest-proxy room updates for follow-me
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unloaded:
        ...
        coordinator.stop_location_tracking()
